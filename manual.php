...
<head>
		<!-- Basic -->
		<title>ROBOCELL | Manual Bots</title>
              ...
              <div class="tab-pane fade in active" id="tab-2">
                  ...
                  <div class="col-md-12">
                    ...
                    <font size="3">
                      ...
                      <li><i class="fa fa-check-circle"></i> Now put the shaft inside the hub and fix it using a screw.</li>  <center> <img src="images/manual/pic19.png"> </center>
                      <li><i class="fa fa-check-circle"></i> Attach 2 LAN wires with terminals and connect them with a DPDT switch.</li>  
                      <li><i class="fa fa-check-circle"></i>Now place a L-Clamp on the hand platform and place 100 RPM motor in the clamp and fix it.</li>
