...
<head>
  ...
  <!-- Basic -->
  <title>Robocell | Contact Us</title>
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-md-8">
            ...
            <!-- Start Contact Form -->
            <form action="php/check.php" role="form" class="contact-form" id="contact-form" method="post">
          ...
          <div class="col-md-4">
            ...
            <!-- Some Info -->
            <p>RoboCell, Centre for Cognitive Activities, NIT Durgapur</p>
            ...
            <ul class="icons-list">
              ...
              <li><i class="fa fa-mobile"></i> <strong>Phone:</strong> +91 9421504863</li>
            </ul>
              ...
              <form class="subscribe">
                ...
                <div class="footer-widget social-widget">
                  ...
                  <ul class="social-icons">
                    ...
                    <li>
                      <a class="dribbble" href="https://www.youtube.com/channel/UCrKbVHAMV8lkh25pck7RdcQ"><i class="fa fa-youtube"></i></a>
                    </li>
                    <!--
<li>
